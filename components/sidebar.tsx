...
export default function Sidebar() {
    return (
        <>
            <div className="w-64 h-screen py-4 px-3 bg-gray-50 rounded">
                ...
                <div className="grid-cols-1 gap-4 content-start space-y-2">
                    <SidebarEntry link="/" name="Dashboard" addition=""
                    ...
                    />
                    <SidebarEntry link="/overview" name="Übersicht" addition={<span
                    ...
                    />
                    <SidebarEntry link="/export" name="Exportieren"
                                  addition={<span
                    ...
                    />
                    <SidebarEntry link="/teacher" name="Lehrer" addition=""
                                  icon={
                                      <svg
                                          className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900"
                                          fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
